...
SECRET_KEY = 'django-insecure-p^l47s_#is559%=9j@e@3rtfu-9a!m%w8q6m^rx4&24ee641cu'
...
# declarations and imports for deployment
import socket
CS_DEPLOYMENT_HOSTNAME = 'cs-webapps.bu.edu'

if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = '/nsent01/static/'
    MEDIA_URL = '/nsent01/media/'